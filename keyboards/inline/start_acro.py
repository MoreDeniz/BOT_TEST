...
kb_main_menu_acro = InlineKeyboardMarkup(row_width=2)
...
btn_my_events = InlineKeyboardButton(text='Мои события',
                                     callback_data=select_event.new(menu='my_events',
                                                                    location='', city='',
                                                                    org_id=0, date='',
                                                                    current_id=0))
...
kb_main_menu_acro.row(btn_search_events, btn_my_events)
kb_main_menu_acro.row(btn_settings)